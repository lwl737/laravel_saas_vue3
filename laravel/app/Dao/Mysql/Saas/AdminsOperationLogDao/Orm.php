...
namespace App\Dao\Mysql\Saas\AdminsOperationLogDao;
...
class Orm extends BaseDev{
    ...
    public function listConfig(array $params){
        ...
        if(isset($params['insert_organi_name']) &&  $params['insert_organi_name'] !== null) $this->query = $this->query->where("organi.organi_name" , "like" , (string)$params['insert_organi_name'] . "%") ;

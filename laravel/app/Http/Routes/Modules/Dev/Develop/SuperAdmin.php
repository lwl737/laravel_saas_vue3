...
use App\Rules\{Phone, NotZero, EnumVal};
...
class SuperAdmin implements Routes
{
    ...
    {
        return [
            "list" => ["method" => "get", "valid" => ["pageNum", "pageSize", "nick_name" => ["string", 'max:50'],'real_name' => ["string", 'max:50'], 'phone' => ["string", 'max:50']]],
            "add" => ["method" => "post", "valid" => ["username", "password", "status", "portrait", "nick_name", "real_name", "phone"]],
            "editStatus" => ["method" => "put", "valid" => ['status', "admins_id"]],
            "edit" => ["method" => "put", "valid" => ["admins_id", "username", "password" => ["string", "size:32"], "status", "portrait", "nick_name", "real_name", "phone"]],

  ...
  <div class="main-box">
    ...
    >
      <template #filterHeader>
        <el-button type="primary" :icon="CirclePlus" @click="() => openDrawer()">添加页面</el-button>
      </template>
      <template #lineRight="{ data }">
        <el-dropdown>
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item @click="() => treeEdit(data)">编辑</el-dropdown-item>
              <el-dropdown-item @click="() => addSon(data)">添加子级</el-dropdown-item>
              <el-dropdown-item @click="() => treeDel(data)">删除</el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
      </template>
        ...
        <el-tab-pane name="apiTable">
          ...
          >
            ...
            <template #tableHeader>
              <el-button type="primary" :icon="CirclePlus" @click="() => openMenuApiDialog()" v-show="initParam.menu_id !== 0">
                新增api
              </el-button>
            </template>
            <!-- 表格操作 -->
        ...
        <el-tab-pane label="权限" name="proTable">
          <div class="card-tabs">
            ...
            >
                    ...
                    <el-table :data="scope.row.buttons" border>
                      ...
                      <el-table-column prop="operation" label="操作" width="150">
                        <template #default="buttons">
                          <el-button type="primary" link :icon="EditPen" @click="() => openButtons(scope.row, buttons.row)">
                            编辑
                          </el-button>
                          <el-button type="primary" link :icon="Delete" @click="() => authSonDel('buttons', buttons.row)">
                            删除
                          </el-button>
                        </template>
                      </el-table-column>
                    ...
                    <el-table :data="scope.row.api" border>
                      ...
                      <el-table-column prop="operation" label="操作" width="150">
                        <template #default="api">
                          <el-button type="primary" link :icon="EditPen" @click="() => openApi(scope.row, api.row)">
                            编辑
                          </el-button>
                          <el-button type="primary" link :icon="Delete" @click="() => authSonDel('api', api.row)">删除</el-button>
                        </template>
                      </el-table-column>
                    </el-table>
                  </div>
                  ...
                  <el-table :data="scope.row.pages" border>
                    ...
                    <el-table-column prop="operation" label="操作" width="150">
                      <template #default="pages">
                        <el-button type="primary" link :icon="EditPen" @click="() => openPages(scope.row, pages.row)">
                          编辑
                        </el-button>
                        <el-button type="primary" link :icon="Delete" @click="() => authSonDel('pages', pages.row)">
                          删除
                        </el-button>
                      </template>
                    </el-table-column>
              ...
              <!-- 表格 header 按钮 -->
              <template #tableHeader>
                <el-button type="primary" :icon="CirclePlus" @click="() => openDialog()" v-show="initParam.menu_id !== 0">
                  新增权限
                </el-button>
              </template>
              <!-- 表格操作 -->
...
<script setup lang="tsx" name="DevMenuIndex">

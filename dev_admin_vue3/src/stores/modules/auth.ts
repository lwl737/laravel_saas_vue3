...
import { commonRouter, devRouter } from "@/routers/modules/staticRouter";
export const useAuthStore = defineStore({
  ...
  actions: {
    ...
    async getAuthMenuList() {
      ...
      // this.authMenuList = commonRouter;
    ...
    setAuthMenuList(menu: Menus.MenuOptions[], role_id: number) {
      this.authMenuList = [...commonRouter, ...menu, ...(role_id === -1 ? devRouter : [])];
    },

...
import { useOrganiColumns } from "./useOrgani";
...
// 接收 columns 并设置为响应式
const tableColumns = reactive<ColumnProps[]>(props.columns.concat(props.useOrgani ? useOrganiColumns : []));

<template>
  <component
    ...
    @change="() => (column.changeSearch ? emits('search') : ``)"
  >
    ...
    <template v-if="column.formRender" v-slot="cell">
      <component :is="($event: any) => column.formRender && column.formRender($event, cell)"></component>
    </template>
  </component>
</template>
